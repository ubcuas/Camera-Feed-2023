...
/**
 * @brief Computes a rotation matrix from roll, pitch, and yaw angles in degrees.
 * 
...
/**
 * @brief Computes the X and Y offsets on the ground plane from camera coordinates.
 * 
 ...
 * @return cv::Point2d Offset (X, Y) in X meters East, Y meters North on the ground plane
 */
...
/**
 * @brief Computes a new geographic position by offsetting from a base latitude and longitude.
 * 
...
/**
 * @brief Converts image pixel coordinates to geographic coordinates using camera parameters.
 * 
 * @param roll_deg Roll angle in degrees (rotation around Y-axis)
 * @param pitch_deg Pitch angle in degrees (rotation around X-axis)
 * @param yaw_deg Yaw angle in degrees (rotation around Z-axis)
 ...
 * @param lat Base latitude in degrees
 * @param lng Base longitude in degrees
 * @return std::pair<double, double> Geographic coordinates (latitude, longitude)
 */
